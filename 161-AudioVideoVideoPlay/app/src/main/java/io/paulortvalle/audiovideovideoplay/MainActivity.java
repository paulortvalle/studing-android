package io.paulortvalle.audiovideovideoplay;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaController mMediaController = new MediaController(MainActivity.this, true);

        mMediaController.setEnabled(false);

        mVideoView.setMediaController(mMediaController);

        mVideoView.setVideoURI(Uri.parse("android.resource://io.paulortvalle.audiovideovideoplay/raw/moon"));
