package io.paulortvalle.notificationstatusbar;
...
public class MainActivity extends Activity {
    ...
    private Uri soundURI = Uri.parse("android.resource://io.paulortvalle.notificationstatusbar/" + R.raw.alarm_rooster); // sound doesn't work!
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Notification.Builder notificationBuilder = new Notification.Builder(
                        ...
                        .setContentIntent(mContentIntent).setSound(soundURI) // sound doesn't work!
