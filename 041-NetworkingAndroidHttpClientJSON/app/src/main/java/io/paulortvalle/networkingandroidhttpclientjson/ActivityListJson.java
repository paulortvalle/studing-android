...
public class ActivityListJson extends ListActivity {
    ...
    private class HttpGetTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private static final String URL = "http://api.geonames.org/earthquakesJSON?north=44.1&south=-9.9&east=-22.4&west=55.2&username=" + USER_NAME;
        ...
        protected void onPostExecute(List<String> result) {
            ...
            setListAdapter(new ArrayAdapter<String>(
                    ActivityListJson.this,
                    R.layout.activity_list_json, result));
        }
    }
