...
public class MainActivity extends Activity {
    ...
    private Uri soundURI = Uri.parse("android.resource://io.paulortvalle.notificationstatusbarwithcustomview/" + R.raw.alarm_rooster);
    private long[] mVibratePattern = { 0, 200, 200, 300 };

    RemoteViews mContentView = new RemoteViews("io.paulortvalle.notificationstatusbarwithcustomview",R.layout.custom_notification);
